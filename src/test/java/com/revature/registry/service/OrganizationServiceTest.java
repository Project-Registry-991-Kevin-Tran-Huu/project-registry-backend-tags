...
public class OrganizationServiceTest {
	...
	void init() {
		...
		when(organizationRepository.findById(organization1.getId()))
	...
	void testFindOrganizationByIdReturnOrganization() {
		assertThat(organizationService
				.getOrganizationById(organization1.getId())).isEqualTo(organization1);
	}
	...
	void testRegisterOrganizationReturnOrganization() {
		assertThat(organizationService
				.registerOrganization(organization2)).isEqualTo(organization2);
	}
	...
	void testUpdateOrganizationByIdReturnNull() {
		...
		testOrg.setId(2);
		assertThat(organizationService
				.updateOrganizationById(testOrg.getId(), testOrg)).isNull();
	}
